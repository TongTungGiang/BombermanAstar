...
public class Sprite {
	...
	public static Sprite creep_side_7 = new Sprite(64, 6, 7, SpriteSheet.tiles);
        ...
        public static Sprite coin_1 = new Sprite(64, 0, 8, SpriteSheet.tiles);
	public static Sprite coin_2 = new Sprite(64, 1, 8, SpriteSheet.tiles);
	public static Sprite coin_3 = new Sprite(64, 2, 8, SpriteSheet.tiles);
	public static Sprite coin_4 = new Sprite(64, 3, 8, SpriteSheet.tiles);
	public static Sprite coin_5 = new Sprite(64, 4, 8, SpriteSheet.tiles);
	public static Sprite coin_6 = new Sprite(64, 5, 8, SpriteSheet.tiles);
	public static Sprite coin_7 = new Sprite(64, 6, 8, SpriteSheet.tiles);
	public static Sprite coin_8 = new Sprite(64, 7, 8, SpriteSheet.tiles);
	public static Sprite coin_9 = new Sprite(64, 8, 8, SpriteSheet.tiles);
        
        public static Sprite num_0 = new Sprite(64, 0, 0, SpriteSheet.number);
        public static Sprite num_1 = new Sprite(64, 1, 0, SpriteSheet.number);
        public static Sprite num_2 = new Sprite(64, 2, 0, SpriteSheet.number);
        public static Sprite num_3 = new Sprite(64, 3, 0, SpriteSheet.number);
        public static Sprite num_4 = new Sprite(64, 4, 0, SpriteSheet.number);
        public static Sprite num_5 = new Sprite(64, 5, 0, SpriteSheet.number);
        public static Sprite num_6 = new Sprite(64, 6, 0, SpriteSheet.number);
        public static Sprite num_7 = new Sprite(64, 7, 0, SpriteSheet.number);
        public static Sprite num_8 = new Sprite(64, 8, 0, SpriteSheet.number);
        public static Sprite num_9 = new Sprite(64, 9, 0, SpriteSheet.number);
